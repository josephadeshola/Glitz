...
const heroImages = [
  {
    ...
    heading: "Empowering Global Trade in Premium African Agricultural Commodities",
    subtext: "From sourcing to export, we deliver quality, compliance, and transparency in every shipment.",
    aosType:"fade-up"
  },
  {
  ...
  },
  {
    ...
    heading: "Naturally sun-dried and unprocessed, ideal for industrial use and export.",
