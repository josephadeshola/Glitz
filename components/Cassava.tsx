      ...
      <section data-aos="zoom-in" className="px-4 md:px-8 lg:px-16 py-10 space-y-12">
        <div>
          ...
          <p className="text-gray-700 mt-4 leading-relaxed">
            Nigeria is one of the world’s top producers and exporters of cassava
            products, including dried cassava chips. With vast farmlands and
            favorable conditions, cassava is cultivated extensively for both
            local consumption and export purposes.
          </p>
          <p className="mt-4">
            Cassava chips are a versatile and in-demand commodity, used in
            animal feed, ethanol production, and as a key raw material for
            industrial starch. With increasing global demand and Nigeria's
            consistent supply, cassava chips represent a growing opportunity in
            agro-exports.
          </p>
        </div>
        ...
        <div className="lg:flex justify-between">
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-700 leading-relaxed">
              Cassava chips are dried slices of cassava tubers (Manihot
              esculenta), typically produced by peeling, slicing, and drying the
              roots. These chips are high in carbohydrates and are commonly used
              in animal feed production, ethanol distillation, and even as a
              base for processed snacks in some industries.
            </p>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li className="flex items-start gap-2">
              ...
              Rich in carbohydrates – a great energy source for humans and
              livestock.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" />
              Contains essential vitamins such as vitamin C and some B-complex
              vitamins.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" />
