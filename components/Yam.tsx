    ...
    <div className="bg-white text-gray-800">
      <section className="relative w-full h-[70vh] -mt-10 flex items-center justify-center text-white">
        ...
        <div className="relative z-20 px-4 lg:px-8 text-center max-w-3xl">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Yam</h1>
      ...
      <section className="px-4 md:px-8 lg:px-16 py-10 space-y-12">
        <div>
          <p className="font-bold text-3xl">
            Leading Yam Exporter from Nigeria
          </p>
          <p className="text-gray-700 mt-4 leading-relaxed">
            Nigeria is the world’s largest producer and exporter of yam,
            accounting for over 65% of global yam production. With fertile land
            and favorable climate, yam farming plays a crucial role in Nigeria’s
            agricultural economy and food security.
          </p>
          <p className="mt-4">
            Export-grade yams from Nigeria are known for their quality, size,
            and taste. Nigeria exports primarily white yam (Dioscorea rotundata)
            which is in high demand across Europe, North America, and other
            parts of Africa.
          </p>
        </div>
        ...
        <div className="lg:flex justify-between">
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-700 leading-relaxed">
              Yam is a starchy tuber belonging to the genus *Dioscorea*. It is
              an essential dietary staple in many parts of Africa, especially
              Nigeria, where it is cultivated extensively for both local
              consumption and export. Unlike sweet potatoes, yams have a rough
              brown skin and white, yellow, or purple flesh depending on the
              variety. They are rich in carbohydrates and can be boiled,
              roasted, pounded, or fried.
            </p>
          </div>
          <section className="px-4 lg:w-1/2 md:px-8">
            <h2 className="text-3xl text-[#CC2837] font-bold mb-4">Yam</h2>
            <Zoom>
              <Image
                src="/images/yam.png"
                width={900}
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> High in complex carbohydrates –
              provides long-lasting energy.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Rich in dietary fiber – aids
              digestion and supports gut health.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Contains vitamin C – boosts
              immune function and skin health.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Good source of potassium –
              essential for heart and muscle function.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Contains antioxidants – helps
              fight free radicals and inflammation.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Naturally gluten-free – safe
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Long cylindrical shape with
              rough brown skin.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> White or yellowish flesh inside
              depending on variety.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Typically weighs 2–10 kg per
              tuber.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Requires dry storage conditions
              to prevent sprouting.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Harvested manually with care to
              avoid damage.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Boiled or fried for traditional
              dishes like porridge and yam fries.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Pounded into “pounded yam” and
              served with soups.
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Used in flour production for
              baking or yam flour (elubo).
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="mt-1" /> Can be fermented into products
              like amala or yam fufu.
            </li>
          </ul>
        </div>
