...
const Footer = () => {
    return (
        <>
            ...
            <div className="bg-black mt-80 text-white lg:p-8">
                <div className="max-w-4xl bg-[#CC2837] h-[60vh] py-14 border border-4 lg:px-10 px-5 text-center -mt-48 mx-auto rounded-lg ">
                    <div className="mt-10">
