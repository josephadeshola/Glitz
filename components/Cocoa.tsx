      ...
      >
        <div>
          <p className="font-bold text-3xl">
            Exporter of Cocoa Beans In Nigeria
          </p>
          <p className="text-gray-700 mt-4 leading-relaxed">
            Nigeria ranks among the top cocoa-producing countries in the world,
            contributing significantly to global supply. Cocoa is a key
            agricultural export and plays a vital role in the economy,
            supporting thousands of local farmers and stakeholders.
          </p>
          <p className="mt-4 leading-relaxed">
            We provide premium cocoa beans, sourced from certified farms,
            ensuring proper fermentation, drying, and compliance with
            international quality requirements. <br />
            <strong>Product and Quality:</strong> Our cocoa beans undergo strict
            quality control, are free from defects, and have an ideal moisture
            content (7.5%). We guarantee Fair Trade and ICCO-certified beans,
            packed and stored for optimal freshness during shipment. <br />
            <strong>Logistics:</strong> We manage the entire export process,
            including documentation, customs clearance, and reliable shipping to
            international markets. <br />
            <strong>Conclusion:</strong> Partner with us for consistent,
            top-tier cocoa beans, delivered efficiently to meet your global
            supply needs.
          </p>
        </div>
        ...
        <div className="lg:flex justify-between">
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-700 leading-relaxed">
              Cocoa beans are the dried and fully fermented seeds of Theobroma
              cacao, used primarily to make chocolate. Harvested from cocoa
              pods, these beans are typically fermented for several days and
              then sun-dried to develop flavor. Nigerian cocoa is known for its
              intense aroma and deep color, making it a preferred choice for
