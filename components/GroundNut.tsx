    ...
    return (
        <div className="bg-white text-gray-800">
            ...
            <section className="px-4 md:px-8 lg:px-16 py-10 space-y-12">
                <div>
                    <p className="font-bold text-3xl">Top Exporter of Groundnut In Nigeria</p>
                    <p className="text-gray-700 mt-4 leading-relaxed">Product and Quality: Our peanuts are carefully sorted, free from impurities, and processed to maintain optimal freshness and quality. They meet global standards for size, cleanliness, and moisture content, ensuring a product suitable for various industrial and food applications.</p>
                    <p className="mt-4">Logistics:We provide comprehensive export services, managing documentation, customs clearance, and secure shipping to international buyers, ensuring timely delivery.</p>
                    <p>Conclusion:Choose Still Morris Consults for high-grade peanut efficiently delivered to meet your market demand.</p>
                </div>
                <div>
